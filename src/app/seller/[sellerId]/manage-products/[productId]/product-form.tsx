...
import { SellerProduct, SellerSubCategory } from "@prisma/client";
import {
  Select,
  SelectContent,
  SelectItem,
...
const ProductForm = ({
  ...
  const handleAddProductToStorage = (values: z.infer<typeof formSchema>) => {
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Upload 1 to 7 images in .png, .jpg, .jpeg, .webp format
